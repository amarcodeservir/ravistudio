...
import birthdayImage from '../../assets/birthdayimg1.png';  // Replace with your actual image paths
import birthdayImage2 from '../../assets/birthdayimg2.jpg'; // Replace with your actual image paths
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg md:text-xl text-secondary">
            Capturing moments of joy, laughter, and memories that last a lifetime.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg group">
            ...
            <div className="bg-black bg-opacity-50 absolute inset-0 flex justify-center items-center text-center p-4">
              <h3 className="text-2xl font-semibold text-white">Memorable Moments</h3>
              <p className="text-sm text-white">Capture the essence of your celebration</p>
            </div>
          </div>
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg group">
            ...
            />
            <div className="bg-black bg-opacity-50 absolute inset-0 flex justify-center items-center text-center p-4">
              <h3 className="text-2xl font-semibold text-white">Unforgettable Moments</h3>
              <p className="text-sm text-white">Let us help you relive your special day</p>
            </div>
          </div>
