...
function Discription() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-theam md:px-5 ">
      <div className="rounded-full justify-center flex py-5  ">
        <img
          src={raviing}
          alt="Wedding Photographer"
          className="bg-cover h-64 w-64 md:h-[500px] md:w-[700px] object-cover rounded-full "
        />
      </div>
      <div className="md:px-8 px-2 md:py-10   shadow text-secondary w-full   ">
